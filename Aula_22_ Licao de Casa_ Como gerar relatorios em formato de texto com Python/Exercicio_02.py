...
# cesar           987458
# rosemary        789456125
# Neste arquivo, o nome do usuário possui 15 caracteres. A
# partir deste arquivo, você deve criar um programa que
...
# dados armazenados em memória, caso sejam necessários,
# de forma a agilizar a execução do programa. A conversão
# da espaço ocupado em disco, de bytes para megabytes deverá
...
with open('sample_data/relatorio.txt', 'w') as arquivo:
    ...
    arquivo.writelines('\n')
    arquivo.writelines(f'Espaco total ocupado: {tamanho_total_consumido:.2f} MB\n')
    arquivo.writelines(f'Espaco medio ocupado: {media:.2f} MB\n')
